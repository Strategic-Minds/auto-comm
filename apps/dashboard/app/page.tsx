...
import { ShellBridgePanel } from "./components/ShellBridgePanel";
  ...
  return (
    <main className="site-shell">
      <nav className="top-nav">
        ...
        <div className="nav-actions"><a href="/desktop">Desktop</a><a href="#install">Install</a><a className="primary" href="/api/shell">Shell API</a></div>
      </nav>

      <section className="hero-panel">
        <div className="hero-copy">
          <p className="eyebrow">Installable desktop and mobile website</p>
          ...
          <div id="install" className="install-row"><PwaInstallButtons tone="dark" /></div>
        </div>
      ...
      <section className="console">
        ...
        <aside className="inspector">
          <ShellBridgePanel selected={selected} agents={agents} />
        </aside>
      </section>
